...
#load the parameters:
exec(compile(open('/home/mtllab/Programs/ClearMap0.5/ClearMap/Scripts/parameter_file_Ilastik_template.py', "rb").read(), '/home/mtllab/Programs/ClearMap0.5/ClearMap/Scripts/parameter_file_Ilastik_template.py', 'exec'))
