...
sys.path.insert(0, os.path.join(basedir, 'docs/extensions'))
...
# documentation.
html_theme_options = { "sidebarwidth" : 260}
...
latex_documents = [
  ('index', 'clearmap.tex', 'ClearMap Documentation',
   'Christoph Kirst', 'manual'),
]
...
man_pages = [
    ('index', 'clearmap', 'ClearMap Documentation',
     ['Christoph Kirst'], 1)
]
...
texinfo_documents = [
  ('index', 'ClearMap', 'ClearMap Documentation',
   'Christoph Kirst', 'ClearMap', 'One line description of project.',
   'Miscellaneous'),
]
